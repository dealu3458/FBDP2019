...
public class Join {
    public static class JoinMap extends Mapper<LongWritable, Text, RelationA, IntWritable>{
    ...
    public static class JoinReduce extends Reducer<RelationA, IntWritable, RelationA, NullWritable>{
        @Override
